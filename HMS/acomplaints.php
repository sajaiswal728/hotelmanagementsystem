...
echo"<div id='sandeep'>Hostel :".$hostelc."<br>".$usc["count(serial)"]." Complaints Not Taken under Cosideration(or solved)<br>".$upc["count(serial)"]." Complaints under process</div><br><br>";}
else
	echo"<div id='sandeep'>No Complaints</div>";
...
if($usc["count(serial)"]!=0 or $upc["count(serial)"]!=0){
echo"<div id='sandeep'>Over All : Including all hostels<br>".$usc["count(serial)"]." Complaints Not Taken under Cosideration(or solved)<br>".$upc["count(serial)"]." Complaints under process<br></div>";}
else
	echo"<div id='sandeep'>No Complaints<br></div>";
echo"<div id='sandeep'><a href='capp.php'><font face='Harrington' >Complaint Report And Automated application generator</font></a></div>";
mysqli_close($db);
include "srch.php";
?>
</body>
